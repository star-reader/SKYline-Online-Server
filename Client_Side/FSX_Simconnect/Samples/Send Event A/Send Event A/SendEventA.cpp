        ...
        case SIMCONNECT_RECV_ID_EVENT:
        {
            ...
            switch(evt->uEventID)
            {
                case EVENT_BRAKES:
                    ...
                    SimConnect_TransmitClientEvent(hSimConnect, 0, EVENT_MY_EVENT, 0, SIMCONNECT_GROUP_PRIORITY_HIGHEST, 0);
                    SimConnect_TransmitClientEvent(hSimConnect, 0, EVENT_MASKABLE, 0, SIMCONNECT_GROUP_PRIORITY_HIGHEST, 0);
